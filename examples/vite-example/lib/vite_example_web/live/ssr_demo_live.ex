  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 py-12 px-4">
      <div class="max-w-7xl mx-auto">
        ...
        <p class="text-gray-600 dark:text-gray-300 text-center mb-6 max-w-3xl mx-auto">
        ...
        <div class="flex justify-center mb-8">
          <button
            ...
            class="bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-semibold py-2 px-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer"
          >
            🔄 Reload Page
          </button>
        </div>
        ...
        <div class="grid grid-cols-3 gap-6">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-md dark:shadow-slate-900/50 p-6">
            <div class="mb-4">
              <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">Client-Side Only (No SSR)</h2>
          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-md dark:shadow-slate-900/50 p-6">
            <div class="mb-4">
              <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">SSR with Overwrite</h2>
              <p class="text-xs text-gray-600 dark:text-gray-400">
          ...
          <div class="bg-white dark:bg-slate-800 rounded-xl shadow-md dark:shadow-slate-900/50 p-6">
            <div class="mb-4">
              <h2 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">SSR with Hydration</h2>
              <p class="text-xs text-gray-600 dark:text-gray-400">
