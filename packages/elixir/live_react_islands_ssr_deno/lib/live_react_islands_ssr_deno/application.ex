  ...
  def start(_type, _args) do
    ...
    main_module_path =
      if String.starts_with?(relative_path, "priv/") do
        ...
        Path.join(Application.app_dir(:live_react_islands_ssr_deno, "priv"), priv_relative)
      else
    ...
    children = [
      {LiveReactIslands.SSRServer, [main_module_path: main_module_path]}
    ]

    opts = [strategy: :one_for_one, name: LiveReactIslands.Supervisor]
